...
> LCP는 SEO(검색 엔진 최적화)와 밀접한 관계가 있다.
...
<td align="center" width="150px">
<img height="100px" width="100px" src="https://user-images.githubusercontent.com/97587150/203685292-b842378e-68dd-407a-8bab-0a7dde902475.png" alt="김동신 프로필"/>

</td>
<td align="center" width="150px">
<img height="100px" width="100px" src="https://user-images.githubusercontent.com/97587150/203685331-899407e2-9f6e-40c2-b7f5-2468e31ed649.png" alt="박정현 프로필"/>

</td>
<td align="center" width="150px">
<img height="100px" width="100px" src="https://user-images.githubusercontent.com/97587150/203685363-7a73009c-2559-4fd6-a92e-79aabf5b3c98.png" alt="전병찬 프로필"/>

</td>
<td align="center" width="150px">

<img height="100px" width="100px" src="https://user-images.githubusercontent.com/97587150/203685400-8472d45f-dd8a-4836-b3cf-d04fb60b167a.png" alt="최원재 프로필"/>
...
| 이름   | 역할                   | 개발 내용                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ------ | ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 김현주 | (Front-end & 팀장)     | - 누리봄 셋톱박스 메인, 노래 재생, 초성게임 페이지 기능 및 UI 구현<br/>- Flask와 socket io 를 활용한 소켓 통신서버 기반 구축<br/>- socket io를 활용한 셋톱박스 컨텐츠간 이동 기능 구현<br/>- Firebase를 활용한 사진 및 영상 보관 store 구축<br/>- 사진첩 (사진 및 영상 조회 / 업로드) 기능 구현<br/>- 갤러리 영상편지, 사진 상세조회 기능 구현<br/>- 신규 영상편지 조회알림 기능 구현<br/>- 갤러리 사진을 배경화면으로 지정하는 기능 구현<br/>- 날씨 api를 활용하여 날씨 변화에 따른 셋톱박스 배경 변경기능 구현<br/>- 누리봄 셋톱박스 안내 캐릭터 디자인, 애니메이션 제작 <br/>- 계정관련 (보호자 회원가입/보호자 로그인/ 피보호자 등록/피보호자 정보수정) UI 구현<br/>- 보호자 메인페이지 UI 구현<br/>- 피보호자 페이지 (복약시간 / 방문일정 / 노래 및 체조 시간) UI 구현<br/>- 복약시간 / 방문일정/ 노래 재생시간 / 체조활동 시간 등록 및 수정페이지 UI 구현 |
| 김선후 | (Front-end)            | - 프론트 프로젝트 구조 설계<br/>- 계정관련 (보호자 회원가입/보호자 로그인/ 피보호자 등록/피보호자 정보수정)기능 구현<br/>- 관리자페이지 캘린더, 로딩 컴포넌트(로딩스피너) 구현<br/>- 피보호자 페이지 (복약시간 / 방문일정 / 노래 및 체조 시간) 기능 구현<br/>-코드 스플릿을 통한 성능 최적화<br/>- 셋톱박스 초성게임, 응급상황 기능 구현<br/>- 리덕스 생성 및 관리                                                                                                                                                 |
| 김동신 | (IOT)                  | - Ubuntu 환경 및 Edge TPU 구동 환경 구축<br/>- PoseNet 모델을 활용한 모션인식 기능 구현<br/>- 모션인식 기능을 활용한 체조 및 낙상감지 알고리즘 구현<br/>- 사람인지 여부에 따른 하드웨어 작동 알고리즘 구현<br/> - 복약알림 및 방문일정 등록 페이지 구현<br/> - JIRA 전략 구성 및 스프린트 관리<br/>- Gstreamer를 활용한 영상 녹화 및 송출 기능 구현                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 박정현 | (IOT & Core)           | -Arduino 초음파, 적외선 송신부 회로 구성<br/>-Controller Serial 통신<br/>-LP Linux 환경 설정<br/>-Goggle Cloud Speech STT 모듈 구현<br/>-Naver Clova Voice TTS 모듈 구현<br/>-Coral 모션 인식 모듈, Timer 모듈 , 음성 인식 모듈 통합 및 Controller 구현<br/>-음성인식 결과 분기 처리 및 SocketIO를 통한 백, 프론트간 통신환경 구현 |
| 전병찬 | (Back-end & AI)        | - Code Convention 구성<br/> - JIRA 전략 구성 및 스프린트 관리<br/> - Commit & Branch 전략 구성 및 git-flow 활용<br/> - DB 설계 및 ERD 작성<br/>- Spring Data JPA를 활용한 DB 생성<br/>- DB 데이터 관리<br/>- API 문서 작성<br/>- 보호자 API 구현<br/>- 피보호자 API 구현<br/>- 복약 시간 API 구현<br/>- 방문 일정 API 구현<br/>- 활동 권유 API 구현<br/>- 알림 API 구현<br/>- 날씨 정보 조회 API 구현<br/>- 네이버 클라우드 Simple & Easy Notification Service를 활용한 긴급 상황 알림 메시지 API 구현<br/>- JWT 활용(Access Token)<br/>- Swagger를 활용한 API 문서 자동화<br/>- 프로젝트 진행 과정 산출물 상시 정리 및 기록<br/>- Google Coral(Edge TPU)을 활용한 모션인식 기능 커스텀<br/>- 낙상 감지 알고리즘 설계 및 구현, 테스트<br/>- 체조 알고리즘 설계 및 구현, 테스트<br/>- System Architecture 작성                                                   |
| 최원재 | (IOT-음성인식 & Infra) | - 네이버 CLOVA 챗봇 학습<br/> - 네이비 CLOVA 챗봇 API 호출 모듈 구현<br/> - 음성 인식 구현<br/> - Infra<br/> - 시스템 아키텍처 구성<br/>- Jenkins pipeline 설정<br/>- Nginx 설정<br/> - Docker 설정<br/>- HTTPS 적용 <br/>- CI-CD 구현                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
